...
## values.
N5_DTS_TARGET ?= msm8974-hammerhead


## Don't change anything under here. The variables are named N5_whatever
...
define append-N5-dtb
mkdir -p $(KERNEL_OUT)/arch/arm/boot;\
$(foreach N5_DTS_NAME, $(N5_DTS_NAMES), \
   $(foreach d, $(N5_DTS_FILES), \
